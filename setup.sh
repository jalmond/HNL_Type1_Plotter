...
export PLOT_PATH=/home/jalmond/Dropbox/DiLepton_13TeV/plots/
...
export LIMIT_PATH=$PLOTTER_WORKING_DIR/LimitCode/CMS-StatisticalTools/RooStatsRoutines/Macros_hnl_13TeV/
